...
if __name__ == "__main__":
    ...
    if not os.path.isdir(directory):
        ...
        print("Por favor, ejecute el script nuevamente y proporcione un \
              directorio válido.")
    ...
    if not composer_files:
        print("Advertencia: No se encontraron archivos composer.json en el \
                directorio proporcionado.")
        print("Por favor, coloque los archivos composer.json en el directorio \
                y ejecute el script nuevamente.")
